...
parser.add_argument(
    "--readme", "-r",
    metavar="FILE",
    help="Path to competition README file"
)
parser.add_argument(
    "--auto-readme", "-R",
    action="store_true",
...
parser.add_argument(
    "--password-policy", "-p",
    action="store_true",
    help="Password policy enforcement"
)
parser.add_argument(
...
parser.add_argument(
    "--audit-policy", "-t",
    action="store_true",
    help="Audit policy configuration"
)
parser.add_argument(
    "--firewall", "-f",
    action="store_true",
...
parser.add_argument(
    "--security-hardening", "-k",
    action="store_true",
    help="Security hardening"
)
parser.add_argument(
    "--media-scan", "-m",
    action="store_true",
    help="Prohibited media scanner"
)
parser.add_argument(
    "--all",
    action="store_true",
        ...
        if args.readme and args.auto_readme:
            ...
            if args.readme:
                ...
                if readme.confirm_path(r_path):
                    ...
                    parser.error("Could not find README file: Provided path was not found")
